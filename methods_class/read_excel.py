...
def read_excel(excel_path=BASE_PATH + "/data_case/excel_data/case.xlsx", sheet_name="Sheet1"):
    '''
    读取excel文件内容
...
def get_all_case_name(excel_path=BASE_PATH + "/data_case/excel_data/case.xlsx", sheet_name="Sheet1"):
    """
    获取整个Excel 文件全部的用例名称
    :param excel_path:
    :return:
...
if __name__ == '__main__':
    ...
    data_list = excel_to_list(data_file=BASE_PATH + "/data_case/excel_data/case.xlsx", sheet="Sheet1")  # 读取excel，TestUserLogin工作簿的所有数据
